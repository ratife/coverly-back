package mg.tife.ads.presentation.dto.campaign.mapper;
...
import mg.tife.ads.presentation.dto.campaign.response.MissionTemplateResponse;
...
public interface CampaignDtoMapper {
    ...
    MissionTemplateResponse toTemplateResponse(MissionTemplate template);
